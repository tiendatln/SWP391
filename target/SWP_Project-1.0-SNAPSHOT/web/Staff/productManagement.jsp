                    ...
                    <c:forEach var="product" items="${productList}">
                        <tr>
                            ...
                            <td>
                                ...
                                <button class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#editProductDetailModal${product.productID}">Edit Product Detail</button>
                                <button class="btn btn-outline-danger btn-sm" type="button" style="color: black" onclick="confirmDelete('${product.productID}')"><i class="fa fa-trash"></i></button>
                            </td>
                        </tr>
                    </c:forEach>
                </tbody>

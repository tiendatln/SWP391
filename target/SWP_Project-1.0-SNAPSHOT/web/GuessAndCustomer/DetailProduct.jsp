...
<html lang="en">
    ...
    <body>
        ...
        <div class="container mt-4">
            <h2 class="text-center mb-4" style="font-weight: 600; color: #2c3e50;">Product Details</h2>
            <c:choose>
                        ...
                        <div class="col-md-6 product-details">
                            ...
                            <p><strong>Status:</strong> 
                                <span class="${product.proState == 1 ? 'text-success' : 'text-danger'}">
                                    <c:out value="${product.proState == 1 ? 'In Stock' : 'Out of Stock'}" />
                                </span>
                            </p>
            ...
            <div class="comment-section">
                <h3 class="text-center mb-4" style="color: #2c3e50;">Comments & Reviews</h3>
        ...
        <script>
            document.addEventListener('DOMContentLoaded', function () {
                ...
                // Handle rating stars for new comment
